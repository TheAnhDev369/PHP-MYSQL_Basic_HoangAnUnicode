...
/*Toán tử gán*/
$age = 20; //   Cú pháp: $ten_bien = gia_tri;
$fullName = 'Nguyễn Thế Anh';
const _WEB_HOST_ROOT = 'https://online.unicode.vn'; //ten_hang = gia_tri
echo $fullName .= " năm nay $age tuổi".'<br>';
echo _WEB_HOST_ROOT . ' là nơi anh ấy học lập trình';
...
// Cách viết rút gọn nối biến với chuỗi bằng toán tử .=
$outputStr1 = 'Học lập trình';
$outputStr1 .= ' PHP tại Unicode';
$outputStr1 .= ' miễn phí';
echo $outputStr1;
echo '</br>';
...
// echo $count;
// echo '<br>';
// Thay vì viết như trên ta có thể sử dụng (++) để tăng đơn vị và gán để rút gọn biểu thức
